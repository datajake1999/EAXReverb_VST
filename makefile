...
VSTSDK = VST3_SDK
SRCS = src/biquad.cpp src/bitcrush.cpp src/eaxreverb.cpp src/main.cpp src/resampler.cpp src/ReverbEffect.cpp src/silence.cpp $(VSTSDK)/public.sdk/source/vst2.x/audioeffect.cpp $(VSTSDK)/public.sdk/source/vst2.x/audioeffectx.cpp $(VSTSDK)/public.sdk/source/vst2.x/vstplugmain.cpp
OBJS = audioeffect.o audioeffectx.o biquad.o bitcrush.o eaxreverb.o main.o resampler.o ReverbEffect.o silence.o vstplugmain.o
TARGET = EAXReverb.so
INSTDIR = /usr/lib/vst
