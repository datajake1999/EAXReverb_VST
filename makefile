...
VSTSDK = VST3_SDK
SRCS = src/biquad.cpp src/bitcrush.cpp src/eaxreverb.cpp src/main.cpp src/ReverbEffect.cpp $(VSTSDK)/public.sdk/source/vst2.x/audioeffect.cpp $(VSTSDK)/public.sdk/source/vst2.x/audioeffectx.cpp $(VSTSDK)/public.sdk/source/vst2.x/vstplugmain.cpp
OBJS = audioeffect.o audioeffectx.o biquad.o bitcrush.o eaxreverb.o main.o ReverbEffect.o vstplugmain.o
TARGET = EAXReverb.so
INSTDIR = /usr/lib/vst
